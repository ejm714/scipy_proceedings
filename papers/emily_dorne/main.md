...
[`StratifiedGroupKFold`](https://scikit-learn.org/stable/modules/generated/sklearn.model_selection.StratifiedGroupKFold.html) was used to create five folds stratified on region (https://github.com/drivendataorg/cyfi/blob/a10077449b3b176cb2016ae656da69fb43bf6027/cyfi/pipeline.py#L148-L187) and a model was trained on each fold. CyFi's prediction for a given point is the average across these five models.
