...
The model was trained and evaluated using "in situ" labels collected manually by many organizations across the U.S., visualized below. See the machine learning competition [section](#machine-learning-competition) for details.
